...
| `Carousel` | The contact-sheet rail (2026-07-10): native scroll-snap plates, hard-clipped at the shell edge, with a FOLIO line for controls (hairline · arrow buttons, champagne on hover · page counter). NEVER autoplays — the reader turns the pages; the folio hides itself when everything fits. Homepage: How-we-work steps + blog teasers. |
