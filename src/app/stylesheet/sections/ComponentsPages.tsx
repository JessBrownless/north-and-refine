    ...
    <>
      ...
      >
        ...
        >
          ...
          <Beat n={2} name="HomeHero" what="The bespoke centred masthead, GROUNDLESS on the canvas and in FLOW since the 2026-08-07 layout pass: kicker, H1, CTAs, then the device row bottom-aligned at the foot — the trio on one shelf line at HEIGHT PARITY (the phone's width is derived from the desktop's height, so tops stay level at every viewport), fixed-px phone chrome, no absolute layers left to collide." />
